...
## Purpose
Provides administration features for managing user accounts, listing users with filters, updating roles with audit logs, and assigning granular custom permission overrides.
