# authentication-and-accounts Capability Specification

## Purpose
Provides user account management, authentication endpoints (local and Google OAuth), Sanctum token handling, password reset mechanisms, and profile (/me) retrieval.
